# synthetic_data_apps/plot_privacy_utility_biv5mix_logscale.py
import os
import re
import pandas as pd
...
plt.ylabel("MSE")
plt.title("Privacy–Utility Tradeoff: DP-GRAMS vs MS (Bivariate 5-Modal t-Mixture)")
plt.grid(axis="y", linestyle="--", alpha=0.4)
plt.legend(loc="upper right", frameon=True)

plt.tight_layout()
out_path = os.path.join(results_dir, "privacy_utility_biv5mix_log.png")
